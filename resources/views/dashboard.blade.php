...
<html lang="de">
  <head>
    ...
    <title>{{ config('app.name') }} – Baudokumentation</title>
  ...
  <body>
    ...
    @if (file_exists(public_path('app.config.js')))
      <script src="{{ asset('app.config.js') }}" defer></script>
    @endif
